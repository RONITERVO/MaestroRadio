...
const progress = setInterval(() => episode.progress(playback.playedAt(now()), false), 100);
...
const evidence = { plans, turns, native: native.name, bufferMs: settings.bufferMs, firstAudioMs, ...playback.stats, audioSeconds: episode.totalSamples / 24000,
